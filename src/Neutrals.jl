...
for (f, (g, w, Ts)) in (:(+)   => (:impl_add,    3, (:Number, :Integer, :Rational, :Complex,
                                                     :AbstractIrrational, :AbstractFloat,
                                                     :BigInt, :BigFloat)),
                        :(-)   => (:impl_sub,    3, (:Number, :Integer, :Rational, :Complex,
                                                     :AbstractIrrational, :AbstractFloat,
                                                     :BigInt, :BigFloat)),
                        :(*)   => (:impl_mul,    3, (:Number, :Integer, :Rational, :Complex)),
                        :(/)   => (:impl_div,    3, (:Number, :Integer, :Rational, :Complex)),
